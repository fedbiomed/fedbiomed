        ...
        try:
            ...
            if e.relative_schema_path[0] == "required":
                if "requiredMessages" in self._schema:
                    index = [
                        i for i, val in enumerate(e.validator_value) if val in e.message
                    ][0]
                    if e.validator_value[index] in self._schema["requiredMessages"]:
                        message = self._schema["requiredMessages"][
                            e.validator_value[index]
                        ]
                    else:
                        message = (
                ...
                if (
                    field in self._schema["properties"]
                    and "errorMessages" in self._schema["properties"][field]
                    and reason in self._schema["properties"][field]["errorMessages"]
                ):
                    message = str(
                        self._schema["properties"][field]["errorMessages"][reason]
                    ).format(e.instance)
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "training_plan_id": {
                    ...
                    "minLength": 1,
                    "errorMessages": {
                        "minLength": "model_id must have at least one character"
                    },
                },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "training_plan_id": {
                    ...
                    "minLength": 1,
                    "errorMessages": {
                        "minLength": "model_path must have at least one character"
                    },
                },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "reference_csv_path": {
                    "type": "array",
                    "errorMessages": {"type": "CSV path should be given as an array"},
                },
                "medical_folder_root": {
                    "type": "array",
                    "errorMessages": {
                ...
                "index_col": {
                    "type": "integer",
                    "errorMessage": {"type": "Index column should be an integer"},
                },
            },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "medical_folder_root": {
                    "type": "array",
                    "errorMessages": {"type": "ROOT path should be given as an array"},
                }
            },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                ...
                "modalities": {
                    "type": "array",
                    "errorMessages": {"type": "Modalities should be given as an array"},
                },
                "reference_csv_path": {
                    "type": ["array", "null"],
                    "errorMessages": {"type": "CSV path should be given as an array"},
                ...
                "dlp_id": {
                    "type": ["string", "null"],
                    "errorMessage": {"type": "Data loading plan id should be a string"},
                },
            },
            "required": [
                "medical_folder_root",
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                ...
                "name": {
                    "type": "string",
                    "errorMessages": {"type": "DLP name should be given as an array"},
                },
            },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "email": {
                    "type": "string",
                    "minLength": 1,
                    "errorMessages": {"minLength": "Email is missing"},
                },
                "password": {
                    "type": "string",
                    "minLength": 1,
                    "errorMessages": {"minLength": "Password is missing"},
                },
            },
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                ...
                "name": {
                    "type": "string",
                    "minLength": 1,
                    "errorMessages": {"minLength": "Name is missing"},
                },
                "surname": {
                    "type": "string",
                    "minLength": 1,
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "user_id": {
                    "type": "string",
                    "minLength": 1,
                    "errorMessages": {"minLength": "Missing ID for for to delete"},
                },
            },
            "required": ["user_id"],
            "requiredMessages": {
    ...
    schema = JsonSchema(
        {
            ...
            "properties": {
                "user_id": {
                    "type": "string",
                    "minLength": 1,
                    "errorMessages": {"minLength": "Missing ID for user"},
                },
                "role": {
                    "type": "integer",
                    "enum": [1, 2],
                    "errorMessages": {"enum": "Invalid role"},
                },
            },
