...
c.DockerSpawner.name_template = '{imagename}-{prefix}-{username}-{servername}'
c.DockerSpawner.debug = True
c.DockerSpawner.remove_containers = True


# notebook_dir = os.environ.get('DOCKER_NOTEBOOK_DIR') or '/home'
# c.DockerSpawner.notebook_dir = '/home/fed/fedbiomed'
# Mount the real user's Docker volume on the host to the notebook user's
# notebook directory in the container
#c.DockerSpawner.volumes = { '/home/fedbiomed-notebooks': '/home/jovyan' }


c.DockerSpawner.extra_create_kwargs = {
    'user': os.environ['JUPYTERLAB_USER']
}


# note : mounting '/home/jovyan/.jupyter/jupyter_notebook_config.py' not needed for jupyterhub
c.DockerSpawner.read_only_volumes = {}
for mounts in os.environ['JUPYTERLAB_VOLUME_RO'].split():
    mount = mounts.split(':')
    c.DockerSpawner.read_only_volumes[os.environ['HOST_BASEDIR'] + mount[0]] = mount[1]

c.DockerSpawner.volumes = {}
for mounts in os.environ['JUPYTERLAB_VOLUME_RW'].split():
    mount = mounts.split(':')
    c.DockerSpawner.volumes[os.environ['HOST_BASEDIR'] + mount[0]] = mount[1]


# alternative : one var per mount eg
#c.DockerSpawner.volumes = {
#    os.environ['HOST_BASEDIR'] + os.environ['JUPYTERLAB_VOLRW1_SRC']: os.environ['JUPYTERLAB_VOLRW1_TARG'],
#    os.environ['HOST_BASEDIR'] + os.environ['JUPYTERLAB_VOLRW2_SRC']: os.environ['JUPYTERLAB_VOLRW2_TARG']
#}
...
for envs in os.environ['JUPYTERLAB_ENVIRONMENT'].split():
    ...
    if env[0] == 'UPLOAD_IP':
        uploads_url[0] = env[1]
    elif env[0] == 'UPLOAD_PORT':
        uploads_url[1] = env[1]
    elif env[0] == 'UPLOAD_PATH':
        uploads_url[2] = env[1]
    else:
        c.Spawner.environment[env[0]] = env[1]

c.Spawner.environment['UPLOADS_URL'] = 'http://'+uploads_url[0]+':'+uploads_url[1]+'/'+uploads_url[2]
