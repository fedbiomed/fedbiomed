...
check_vpn_environ() {
    ...
    local required_vpn_vars='VPN_IP VPN_SUBNET_PREFIX VPN_SERVER_ENDPOINT VPN_SERVER_ALLOWED_IPS VPN_SERVER_PUBLIC_KEY VPN_SERVER_PSK'
...
configure_wireguard() {
    ...
    then
        ...
        # useless to save until we have added a peer       
    fi
    ...
    # not needed anymore, remove (privacy provision)
