...
According to our coding rules, the develop branch is usable, tests and tutorials will run, but the documentation may be not fully available or desynchronized with the code. We only provide support for the last release (currently v3.5) aka the master branch.
...
Full installation instruction are also available at: https://fedbiomed.gitlabpages.inria.fr/v3.5/tutorials/installation/0-basic-software-installation/
An installation guide is also provided for Windows10, which relies on WSL2: https://fedbiomed.gitlabpages.inria.fr/v3.5/user-guide/installation/windows-installation/
