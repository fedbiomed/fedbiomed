...
class ErrorNumbers(_BaseEnum):
    ...
    FB407 = "FB407: list of nodes became empty when training (no node has answered or all nodes failed training)"
    FB408 = "FB408: node did not answer during training or training failed"
