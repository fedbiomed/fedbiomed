...
class TrainingArgs:
    ...
    def __init__(
        ...
        if self._ta["dp_args"] is not None:
            try:
                self._ta["dp_args"] = DPArgsValidator.populate_with_defaults(
                    self._ta["dp_args"], only_required=False
                )
    ...
    def _fedprox_mu_validator(
        ...
        """Validates fedprox_mu value whether it None or float or int
        ...
        return (
            False,
            f"Expected `fedprox_mu` value is float or int, but got {type(val)}. ",
        )
    ...
    def default_scheme(cls) -> Dict:
        ...
        return {
            ...
            "dry_run": {"rules": [bool], "required": True, "default": False},
            "batch_maxnum": {
                "rules": [
                    cls._nonnegative_integer_value_validator_hook("batch_maxnum")
                ],
                "required": True,
                "default": None,
            },
            ...
            "log_interval": {"rules": [int], "required": False, "default": 10},
            "fedprox_mu": {
                "rules": [cls._fedprox_mu_validator],
                "required": False,
                "default": None,
            },
            "use_gpu": {"rules": [bool], "required": False, "default": False},
            "dp_args": {
                "rules": [cls._validate_dp_args],
                "required": True,
                "default": None,
            },
            "share_persistent_buffers": {
            ...
            "random_seed": {
                "rules": [cls.optional_type(typespec=int, argname="random_seed")],
                "required": True,
                "default": None,
            },
        }
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        Args:
            key: a key for retrieving data from the dictionary
