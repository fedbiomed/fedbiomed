...
class Round:
    ...
    def _split_train_and_test_data(self, test_ratio: float = 0) -> DataManager:
        ...
        controller_kwargs = self.dataset_entry.get("controller_kwargs", {})
        controller_kwargs["root"] = self.dataset_entry.get("path")

        controller_kwargs |= self.dataset_entry.get("dataset_parameters", {})
