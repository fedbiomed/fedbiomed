...
class ModelManager:
    ...
    def register_model(self,
        ...
        """ This method approves/registers model file through CLI.

           Args:
                name        (str): Model file name. The name should be unique. Otherwise, methods
                                   throws an Exception
                description  (str): Description for model file.
                ...
                model_id    (str): Pre-defined id for model. Default is None. When it is None method
    ...
    def check_hashes_for_registered_models(self):
        ...
        """ This method checks registered models to make sure model files are exist
    ...
    def reply_model_status_request(self, msg, messaging):
        ...
        try:
            ...
            if status != 200:
                ...
                if environ["MODEL_APPROVAL"]:
                    ...
                    reply = {**header,
                             ...
                             'approval_obligation': False,
                             'is_approved': False,
                             'msg': 'This node does not require model approval (maybe for debugging purposes).'}
            ...
            reply = {**header,
                     ...
                     'approval_obligation': False,
                     'is_approved': False,
                     'msg': f'An error occurred when downloading model file. {msg["model_url"]} , {e}'}
    ...
    def register_update_default_models(self):
        ...
        # Models that have been already saved and exist in the database
