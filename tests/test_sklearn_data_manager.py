...
class TestSkLearnDataManager(unittest.TestCase):
    ...
    def test_sklearn_data_manager_03_split(self):
        ...
        self.assertListEqual(self.sklearn_data_manager.testing_index, list(range(len(self.inputs))))
    ...
    def test_sklearn_data_manager_06_save_load_state(self):
        ...
        train_loader, test_loader = self.sklearn_data_manager.split(test_ratio=ratio, test_batch_size=None)
        ...
        new_train_loader, new_test_loader = new_sklearn_data_manager.split(test_ratio=ratio, test_batch_size=None)
        ...
        self.assertFalse(np.array_equal(train_loader.dataset, train_loader_reshuffled.dataset))
        self.assertFalse(np.array_equal(test_loader.dataset, test_loader_reshuffled.dataset))
