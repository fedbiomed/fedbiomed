...
class TestMonitor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patch_add_scalar = patch(
            "fedbiomed.researcher.monitor.SummaryWriter.add_scalar"
        )
    ...
    def test_monitor_01_initialization(self, patch_remove_logs):
    ...
    def test_monitor_02_remove_logs_as_file(self):
        ...
        self.assertFalse(
            ...
            "Tensorboard log file has not been removed properly",
        )
    ...
    def test_monitor_03_remove_logs_if_directory(self):
        ...
        self.assertFalse(
            ...
            "Tensorboard log folder has not been removed properly",
        )
    ...
    def test_monitor_05_summary_writer(self):
        ...
        self.monitor._summary_writer(
            "Train", node_id, metric={"Loss": 12, "Loss2": 14}, cum_iter=1
        )
    ...
    def test_monitor_06_on_message_handler(self, mock_summary_writer):
        ...
        mock_summary_writer.assert_called_once_with(
            header="VALIDATION ON GLOBAL UPDATES",
            node="asd123",
            metric={"metric_1": 12, "metric_2": 13},
            cum_iter=1,
        )
        ...
        mock_summary_writer.reset_mock()
        self.monitor.set_tensorboard(True)
        self.monitor.set_tensorboard(
            "not_a_bool"
        )  # as a side effect, this will set tensorboard flag to false
        self.monitor.on_message_handler(
            {
                "researcher_id": "123123",
                "node_id": "asd123",
    ...
    def test_monitor_07_close_writers(self, mock_close):
        ...
        self.monitor._summary_writer(
            header="VALIDATION ON GLOBAL PARAMETERS",
            node="asd123",
            metric={"metric_1": 12, "metric_2": 13},
            cum_iter=1,
        )
...
class TestMetricStore(unittest.TestCase):
    ...
    def test_metric_store_01_add_iteration_for_train_loss(self):
        ...
        cum_iter, *_ = self.metric_store.add_iteration(
            node=node_1,
            train=True,
        ...
        expected = {
            "node-1": {
                ...
                "training": {"Metric_1": {1: {"iterations": [1], "values": [12]}}},
            }
        }
        self.assertDictEqual(
            self.metric_store,
            expected,
            "Iteration could not set properly for the first train iteration of node-1",
        )
        ...
        self.assertDictEqual(
            self.metric_store,
            expected,
            "Iteration could not set properly for the first train iteration of node-2",
        )
        self.assertEqual(cum_iter, 1)
        ...
        expected["node-1"]["training"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
            expected,
            "Iteration could not set properly for the first "
        ...
        expected["node-2"]["training"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-1"]["training"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
            expected,
            "Iteration could not set properly for the second "
        ...
        expected["node-2"]["training"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-1"]["training"]["Metric_1"].update(
            {2: {"iterations": [1, 2], "values": [12, 12]}}
        )
        self.assertDictEqual(
            self.metric_store,
            expected,
            "Second iteration could not set properly for the second "
            "round of training for node-1",
        )
    ...
    def test_metric_store_02_add_iteration_for_test_on_global_updates(self):
        ...
        expected = {
            "node-1": {
                ...
                "testing_local_updates": {},
                "testing_global_updates": {
                    "Metric_1": {1: {"iterations": [1], "values": [12]}}
                },
            }
        }
        self.assertDictEqual(
        ...
        expected["node-1"]["testing_global_updates"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-2"]["testing_global_updates"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-1"]["testing_global_updates"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-2"]["testing_global_updates"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
    ...
    def test_metric_store_03_add_iteration_for_test_on_local_updates(self):
        ...
        expected["node-1"]["testing_local_updates"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-2"]["testing_local_updates"].update(
            {"Metric_2": {1: {"iterations": [1], "values": [12]}}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-1"]["testing_local_updates"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
        ...
        expected["node-2"]["testing_local_updates"]["Metric_1"].update(
            {2: {"iterations": [1], "values": [12]}}
        )
        self.assertDictEqual(
            self.metric_store,
    ...
    def test_metric_store_05_register_metric(self):
        ...
        self.metric_store._register_metric(
            "node-1", "testing_global_updates", "Metric_1"
        )
        expected["node-1"]["testing_global_updates"].update(
            {"Metric_1": {1: {"iterations": [], "values": []}}}
        )
        ...
        self.metric_store._register_metric(
            "node-2", "testing_global_updates", "Metric_1"
        )
        expected["node-2"]["testing_global_updates"].update(
            {"Metric_1": {1: {"iterations": [], "values": []}}}
        )
        ...
        self.metric_store._register_metric(
            "node-1", "testing_local_updates", "Metric_1"
        )
        expected["node-1"]["testing_local_updates"].update(
            {"Metric_1": {1: {"iterations": [], "values": []}}}
        )
        ...
        self.metric_store._register_metric(
            "node-2", "testing_local_updates", "Metric_1"
        )
        expected["node-2"]["testing_local_updates"].update(
            {"Metric_1": {1: {"iterations": [], "values": []}}}
        )
