...
import fedbiomed.researcher._federated_workflow
from fedbiomed.common.exceptions import FedbiomedSilentTerminationError, FedbiomedError
from fedbiomed.researcher._federated_workflow import exp_exceptions
...
class TestExpExceptions(ResearcherTestCase):
    ...
    def test_exp_exception_4_fedbiomed_error(self):
        ...
        # on notebook
        with patch.object(fedbiomed.researcher._federated_workflow, 'is_ipython', create=True) as m:
            m.return_value = True
