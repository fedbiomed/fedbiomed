...
from fedbiomed.common.optimizers.declearn import AuxVar, ScaffoldAuxVar, ScaffoldServerModule, YogiModule
...
class TestOptimizer(unittest.TestCase):
    ...
    def test_optimizer_17_load_state_and_aux_var(self):
        ...
        """
        # Set up a researcher-side optimizer with a Scaffold module.
        # Initialize its internal states based on mock aggregated node updates.
