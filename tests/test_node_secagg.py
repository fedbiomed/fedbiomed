...
class TestSecaggRound(NodeTestCase):
    ...
    def setUp(self):
        ...
        self.skmanager_p = patch.object(
            fedbiomed.node.secagg._secagg_round, "SKManager", autospec=True
        )  # pylint: disable=W0212
        self.dhmanager_p = patch.object(
            fedbiomed.node.secagg._secagg_round, "DHManager", autospec=True
        )  # pylint: disable=W0212
    ...
    def test_01_secagg_round_instantiation(self):
        ...
        with self.assertRaises(FedbiomedError):
            SecaggRound(secagg_arguments={}, experiment_id="test-id")

        self.env["SECURE_AGGREGATION"] = False
        with self.assertRaises(FedbiomedError):
            SecaggRound(secagg_arguments=self.secagg_arguments, experiment_id="test-id")
    ...
    def test_04_secagg_round_lom_instantiate(self):
        ...
        self.dhmanager.get.return_value = {"parties": ["node-1", "node-2"]}
