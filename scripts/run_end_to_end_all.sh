...
conda env update -f ./envs/development/conda/fedbiomed-researcher-end-to-end.yaml
...
test_counter=1
for notebook in ${list_notebooks[@]}; do # \todo remove the split :..:.. when all notebooks are working.
