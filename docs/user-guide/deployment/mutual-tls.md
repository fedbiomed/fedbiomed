...
| Certificate within 30 days of expiry | Holds that certificate | Connects normally | Warning `Certificate <component_id> expires on <date>`, when the trust bundle is re-read |
