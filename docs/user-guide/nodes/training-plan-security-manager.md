...
```shell
$ ENABLE_TRAINING_PLAN_APPROVAL=True  ALLOW_DEFAULT_TRAINING_PLANS=False fedbiomed node --directory ./my-node start
```
...
```shell
$ ENABLE_TRAINING_PLAN_APPROVAL=True ALLOW_DEFAULT_TRAINING_PLAN=True fedbiomed node --directory ./my-node  start
```
...
```shell
# EDITOR=emacs fedbiomed node --directory ./my-node training-plan view

$ fedbiomed node --directory ./my-node training-plan view
```

After reviewing the training plan, use one of the following commands to either approve or reject the training plan:

```shell
$ fedbiomed node --directory ./my-node training-plan approve

$ fedbiomed node --directory ./my-node training-plan reject
```
...
```shell
$ fedbiomed node --directory ./my-node training-plan delete
```
...
```shell
$ fedbiomed node --directory ./my-node training-plan register
```
...
```shell
$ fedbiomed node --directory ./my-node training-plan update
```
