...
# check that num_nodes is greater than 0 and less than 202
if num_nodes <= 0 or num_nodes >= 202:
    raise ValueError('num_nodes must be greater than 0 and less than 202')
